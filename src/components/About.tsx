...
const About = () => {
    return (
        <section className="relative w-full h-min-[30vh] zidx-4" id="about">
            ...
            <Image src="/svg/2waves.svg" alt="Waves background" layout="fill" objectFit="cover" className="absolute top-0 left-0 w-full h-full z-0" />
            
            <div className="relative z-10 w-full md:-mt-12">
                <div className="relative text-gray-700 w-96 flex flex-col gap-8 bg-white p-8 text-center mx-auto py-24 rounded-md">
